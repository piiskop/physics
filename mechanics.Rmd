...
$$t = \frac{l \cdot (h_{lower} + h_{higher}) \cdot \frac{h_{higher} \cdot s}{h_{eyes}} }{\frac{v}{\frac{\rho_{min} + \rho_{max}}{2}}} === \frac{l \cdot (h_{lower} + h_{higher}) \cdot h_{higher} \cdot s \cdot (\rho_{min} + \rho_{max})}{h_{eyes} \cdot v \cdot 2}$$
