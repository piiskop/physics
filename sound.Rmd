...
![Pillikeel ja lainepikkus](sound/vibstr1.gif)
...
Kui suur on sagedusega 562 Hz heli lainepikkus puidus, kui heli kiirus puidus on 4000 m/s? Vastus esitada kolme tüvenumbriga ja lisada ühik.
...
`r signif(wavelengthOfSound, digits = 3)` * m on heli lainepikkus puidus, kui heli kiirus puidus on $4000 \cdot \frac{m}{s}$.
