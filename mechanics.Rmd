...
$$jõnks = \frac{d(kiirendus)}{d({ajavahemik})}$$

$${d({ajavahemik})} = jõnks \cdot d({kiirendus})$$

$$\int_{algkiirendus}^{kiirendus}d(kiirendus) === \int_{0}^{ajavahemik}jõnks \cdot d(ajavahemik)$$

$$kiirendus - algkiirendus === jõnks \cdot ajavahemik$$
...
$$kiirendus = \frac{d(kiirus)}{d(ajavahemik)}$$

\begin{equation}
d(kiirus) === kiirendus \cdot d(ajavahemik)
(\#eq:acceleration)
\end{equation}

Asendan valemisse \@(eq:acceleration) kiirenduse valemist \@(eq:zeroeth-equation-of-motion-for-constant-jerk):

$$d(kiirus) === (algkiirendus + jõnks \cdot ajavahemik) \cdot d(ajavahemik)$$

$$\int_{algkiirus}^{kiirus}d(kiirus) === \int_{0}^{ajavahemik}(algkiirendus + jõnks \cdot ajavahemik) \cdot d(ajavahemik)$$

$$kiirus - algkiirus === algkiirendus \cdot ajavahemik + \frac{jõnks \cdot ajavahemik^2}{2}$$
...
\begin{equation}
\overrightarrow{hetkekiirus} = \frac{d(\overrightarrow{vahemaa})}{d(ajavahemik)}
(\#eq:momentvelocity)
\end{equation}
...
\begin{equation}
d(\overrightarrow{vahemaa}) = \overrightarrow{hetkekiirus} \cdot d(ajavahemik)
