...
$$vahemaaLõpp = vahemaaAlgus + {kiirus}_{start} * aeg + \frac{kiirendus * aeg ^ 2}{2}$$

$$vahemaaLõpp = vahemaaAlgus + {kiirus}_{start} * \frac{{kiirus}_{lõpp} - {kiirus}_{start}}{kiirendus} + \frac{kiirendus * (\frac{{kiirus}_{lõpp} - {kiirus}_{start}}{kiirendus}) ^ 2}{2}$$

$$vahemaa = \frac{{kiirus}_{start} * {kiirus}_{lõpp} - {kiirus}_{start} ^ 2}{kiirendus} + \frac{\frac{{kiirus}_{lõpp} ^ 2 - 2 * {kiirus}_{lõpp} * {kiirus}_{start} + {kiirus}_{start} ^ 2}{kiirendus}}{2}$$

$$vahemaa = \frac{{kiirus}_{start} * {kiirus}_{lõpp} - {kiirus}_{start} ^ 2}{kiirendus} + \frac{{kiirus}_{lõpp} ^ 2 - 2 * {kiirus}_{lõpp} * {kiirus}_{start} + {kiirus}_{start} ^ 2}{2 * kiirendus}$$

$$vahemaa = \frac{2 * {kiirus}_{start} * {kiirus}_{lõpp} - 2 * {kiirus}_{start} ^ 2 + {kiirus}_{lõpp} ^ 2 - 2 * {kiirus}_{lõpp} * {kiirus}_{start} + {kiirus}_{start} ^ 2}{2 * kiirendus}$$

$$vahemaa = \frac{{kiirus}_{lõpp} ^ 2 - {kiirus}_{start} ^ 2}{2 * kiirendus}$$

#### Kiirendus

$$kiirendus = \frac{{kiirus}_{lõpp} - {kiirus}_{start}}{aeg} === \frac{{kiirus}_{lõpp} ^ 2 - {kiirus}_{start} ^ 2}{2 * vahemaa}$$
