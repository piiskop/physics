...
Võimsus on 62.1 * W. Tundub, et seda pole vaja kasutada. Kasutan hoopis lainepikkuse ja sageduse valemit:

```{r}
numberOfPhotons <- SPEED_LIGHT / 1200e-9 * 60
```

`r format(numberOfPhotons, digits = 2)` footonit kiirgab lamp 1 * min kestel, kui kogu tarbitud elektrienergia muundatakse valgusenergiaks.
