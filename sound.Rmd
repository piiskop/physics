...
Heliallika lähenemisel:

$${sagedus}_{vastuvõetavHeli} = {sagedus}_{heliallikast} * (1 + \frac{{kiirus}_{heliallikas}}{{kiirus}_{heliÕhus}})$$
Heliallika kaugenemisel:
