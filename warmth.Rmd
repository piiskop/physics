...
p_1 \cdot V_1^γ \cdot \int_{V_1}^{V_2}V^{-γ} \cdot d(V) === p_1 \cdot V_1^γ \cdot \frac{1}{-γ + 1} \cdot V^{-γ + 1}|_{V_1}^{V_2} === \frac{p_1 \cdot V_1^γ}{1 - γ} \cdot \frac{1}{V^{γ - 1}}|_{V_1}^{V_2} === \frac{p_1 \cdot V_1^γ}{1 - γ} \cdot [\frac{1}{V_2^{γ - 1}} - \frac{1}{V_1^{γ - 1}}] === \frac{p_1 \cdot V_1^γ}{1 - γ} \cdot [\frac{V_1^{γ - 1}}{V_1^{γ - 1} \cdot V_2^{γ - 1}} - \frac{1}{V_1^{γ - 1}}] === \frac{p_1 \cdot V_1^γ}{1 - γ} \cdot \frac{1}{V_1^{γ - 1}} \cdot [\frac{V_1^{γ - 1}}{V_2^{γ - 1]}} - 1] === \frac{p_1}{1 - γ} \cdot V_1^{γ - γ + 1} \cdot []$$
